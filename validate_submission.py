...
def main():
    ...
    parser.add_argument("--data_dir", help="Path to the DATA dir of the kit. Default: ./DATA/.", default='/home/son/Downloads/wsdm22_cup_xmrec/valid_t1_s2_baseline_toy.tsv')
